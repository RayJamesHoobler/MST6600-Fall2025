...
![Ch 6.4 Time Series Models](images/NIST book cover.gif){width=50%}  
...
## Fit an ETS Model to the `co2` data (1/5)
...
## Fit an ETS Model to the `co2` data (2/5)
...
## Fit an ETS Model to the `co2` data (3/5)
...
## Fit an ETS Model to the `co2` data (4/5)
...
## Fit an ETS Model to the `co2` data (5/5)
